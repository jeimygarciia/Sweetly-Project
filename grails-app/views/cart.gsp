        ...
        <div class="col-full">
            ...
            <div class="pizzaro-secondary-navigation">
                <nav class="secondary-navigation"  aria-label="Secondary Navigation">
                    <ul  class="menu">
                        <li class="menu-item"><a href="shop-grid-3-column.html"><i class="po po-pizza"></i>Cakes</a></li>
                        <li class="menu-item"><a href="shop-grid-3-column.html"><i class="fas fa-cheese"></i>CheeseCake</a></li>
                        <li class="menu-item"><a href="shop-grid-3-column.html"><i class="po po-salads"></i>Cookies</a></li>
