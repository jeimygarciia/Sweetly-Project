                        ...
                        <div class="entry-content">
                            <div class="woocommerce">
                                ...
                                <ul class="woocommerce-thankyou-order-details order_details">
                                    <li class="order">Order Number:<strong></strong></li>
                                    <li class="date">Date:<strong></strong></li>
                                    <li class="total">Total:<strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>00.00</span></strong></li>
                                ...
                                <table class="shop_table order_details">
                                    ...
                                    <tr class="order_item">
                                        <td class="product-name">
                                            <a href="single-product-v1.html"></a> <strong class="product-quantity"></strong>
                                            <dl class="variation">
                                                <dt class="variation-PickSize362590"><span id="1">Pick Size</span> (<span class="woocommerce Price amount amount"><span class="woocommerce Price currencySymbol">$</span>00.00</span>):</dt>
                                                <dd class="variation-PickSize362590">
                                                    <p></p>
                                                </dd>
                                            </dl>
                                        </td>
                                        <td class="product-total"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>00.00</span>  </td>
                                    </tr>
                                    </tbody>
                                    <tfoot>
                                    <tr>
                                        <th scope="row">Subtotal:</th>
                                        <td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>00.00</span></td>
                                    </tr>
                                    <tr>
