            ...
            <div class="header-wrap">
                ...
                <nav id="site-navigation" class="main-navigation"  aria-label="Primary Navigation">
                    ...
                    <div class="handheld-navigation">
                        ...
                        <ul  class="menu">
                            <li class="menu-item"><a href="shop-grid-3-column.html"><i class="fas fa-birthday-cake"></i>Cakes</a></li>
                            <li class="menu-item"><a href="shop-grid-3-column.html"><i class="fas fa-cheese"></i>Cheesecakes</a></li>
                            <li class="menu-item"><a href="shop-grid-3-column.html"><i class="fas fa-cookie"></i>Cookies</a></li>
                        </ul>
                    </div>
                </nav>
                <!-- #site-navigation -->
