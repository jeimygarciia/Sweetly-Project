...
<html>
    ...
    <body>
        ...
        <div id="show-productos" class="content scaffold-show" role="main">
            ...
            <f:display bean="productos" />
            <g:form resource="${this.productos}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.productos}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
