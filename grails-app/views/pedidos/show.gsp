...
<html>
    ...
    <body>
        ...
        <div id="show-pedidos" class="content scaffold-show" role="main">
            ...
            <f:display bean="pedidos" />
            <g:form resource="${this.pedidos}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.pedidos}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
