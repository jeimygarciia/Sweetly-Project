         ...
         <main id="main" class="site-main" >
            <div class="home-v1-slider" >
               <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                  <div class="item slider-1" style="background-image: url('/assets/slider/homepage-slider-1.jpg');">
                     <div class="caption fadeIn">
                        ...
                        <div class="title">SUPREME CAKE</div>
                  ...
                  <!-- /.item -->
                  <div class="item slider-2" style="background-image: url('/assets/slider/homepage-slider-2.jpg');">
                     <div class="caption fadeIn">
                        <div class="price-tag">
                           <div class="border front"> </div>
                           <div class="price-tag-value">
                              <div class="price"><span class="symbol">$</span>299<span class="slider-amount">99<br><span class="price-only">only</span></span> </div>
                           </div>
                           <div class="border back"> </div>
                        </div>
                        <div class="title">WEDDING CAKES </div>
                        <div class="sub-title">WEDDINGS LOVERS SET</div>
                     </div>
                     <!-- /.caption -->
                  </div>
                  <!-- /.item -->
                  ...
                  <!-- /.item -->
                  <div class="item slider-4" style="background-image: url('/assets/slider/homepage-slider-4.jpg');">
                     <div class="caption fadeIn">
                        <div class="pre-title">EXCLUSIVE OFFER</div>
                        <div class="title"><span>GRADUATION CAKE</span><br>DELICIOUS!</div>
                     </div>
                     <!-- /.caption -->
                  </div>
                  <!-- /.item -->
               ...
               <div class="row">
                  <div class="col-xs-12 col-sm-6">
                     <div class="banner top-left" >
                        <a href="#">
                           <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url('/assets/homepage-banners/1.jpg'); height: 442px;">
                              <div class="caption">
                                 <h3 class="title">PATRIOTIC CELEBRATION CAKE</h3>
                                 <h4 class="subtitle">Our traditional vanilla celebration cake decorated for the Fourth of July</h4>
                  ...
                  <div class="col-xs-12 col-sm-6">
                     <div class="banners">
                        <div class="row">
                           <div class="banner col-sm-6 top-right" >
                              <a href="#">
                                 <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url('/assets/homepage-banners/2.jpg'); height: 210px;">
                                    <div class="caption">
                                       <h3 class="title">FREE</h3>
                                       <h4 class="subtitle">MINI CUPCAKES</h4>
                           ...
                           <div class="banner col-sm-6 top-right" >
                              <a href="#">
                                 <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url('/assets//homepage-banners/3.jpg'); height: 210px;">
                                    <div class="caption">
                                       <h3 class="title">WHOOPIE PIES</h3>
                     ...
                     <div class="banner center" >
                        <a href="#">
                           <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url('/assets/homepage-banners/4.jpg'); height: 210px;">
                              <div class="caption">
            ...
            <div class="section-tabs">
               <ul class="nav nav-tabs pizzaro-nav-tabs" >
                  <li class="nav-item">
                     <a href="#h1-tab-products-1" data-toggle="tab">CAKES</a>
                  </li>
                  <li class="nav-item active">
                     <a href="#h1-tab-products-2" class="active" data-toggle="tab">CHEESECAKES</a>
                  </li>
                  <li class="nav-item">
                     <a href="#h1-tab-products-3" data-toggle="tab">COOKIES</a>
                  </li>
               </ul>
                                 ...
                                 <li class="product ">
                                    <div class="product-outer">
                                       <div class="product-inner">
                                          <div class="product-image-wrapper">
                                             <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
                                                <asset:image src="products/s12.jpg" class="img-responsive" absolute="true" alt="" />
                                             </a>
                                          </div>
                                          <div class="product-content-wrapper">
                                             <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
            ...
            <div class="stretch-full-width section-products-sale-event"  style="background-size: cover; background-position: center center; background-image: url('/assets/homepage-banners/5.jpg'); height: 468px;">
               <div class="sale-event-content">
                  <h3 class="pre-title"><span>Special</span></h3>
                  <h2 class="section-title">BLUEBERRY PANCAKE BREAKFAST CUPCAKES!</h2>
                           ...
                           <div  class="ywapo_group_container ywapo_group_container_radio form-row form-row-wide " data-requested="1" data-type="radio" data-id="1" data-condition="">
                              ...
                              <div class="ywapo_input_container ywapo_input_container_radio">
                                 ...
                                 <span class="ywapo_label_tag_position_after">
                                    <span class="ywapo_option_label ywapo_label_position_after">8 lb</span>
                                 </span>
                                 <span class="ywapo_label_price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>240.90</span></span>
                              </div>
